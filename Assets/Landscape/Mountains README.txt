...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Mountains&box=7.614004,46.662833,7.352215,46.483170
...
-----------
  ...
  * Mountains Height Map (ASTER 30m).png
  ...
  * Mountains Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Mountains Height Map (SRTM3 v4.1).png
  ...
  * Mountains Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 651m (actual) is equal to 40m in
